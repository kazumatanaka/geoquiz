...
const geographyMaster = [
  {
    ...
    "type": "river",
    "charName": "シアン・ストリーム",
    "charImage": "assets/avatars/avatar_crystal_lake_spirit_1773565129221.png",
    "region": "chubu",
    "rarity": "SSR",
    ...
    "type": "mountain",
    "charName": "ハイダ・ピーク",
    "charImage": "assets/avatars/avatar_gold_warrior_1773565116360.png",
    "region": "chubu",
    "rarity": "SSR",
    ...
    "type": "plain",
    "charName": "テラ・カントウ",
    "charImage": "assets/avatars/avatar_basin_earth_spirit_1773565212510.png",
    "region": "kanto",
    "rarity": "SR",
    ...
    "type": "plain",
    "charName": "イシカリ・ランド",
    "charImage": "assets/avatars/avatar_northern_frontier_ranger_1773565275110.png",
    "region": "hokkaido",
    "rarity": "R",
    ...
    "type": "mountain",
    "charName": "マウント・フジ",
    "charImage": "assets/avatars/avatar_crimson_volcano_knight_v2_1773565175277.png",
    "region": "chubu",
    "rarity": "SSR",
    ...
    "type": "channel",
    "charName": "キイ-ゲート",
    "charImage": "assets/avatars/avatar_shadow_cliffs_ninja_1773565256660.png",
    "region": "kinki",
    "rarity": "R",
    ...
    "type": "cape",
    "charName": "ソウヤ-ノース",
    "charImage": "assets/avatars/avatar_storm_cape_guardian_1773565144440.png",
    "region": "hokkaido",
    "rarity": "N",
    ...
    "stats": { "最高峰": "祖母山 (1,756m)", "特徴": "九州の背骨" },
    "charStats": { "power": 75, "defense": 70, "speed": 40 },
    "relatedKeywords": ["祖母山", "九州の背骨", "球磨川"],
    "dummyKanji": ["筑", "紫", "讃", "岐", "石", "鎚", "雲", "仙"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "2,236m", "通称": "出羽富士" },
    "charStats": { "power": 88, "defense": 82, "speed": 45 },
    "relatedKeywords": ["出羽富士", "日本海", "氷河"],
    "dummyKanji": ["鳥", "海", "磐", "梯", "白", "岩", "木"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "1,816m", "湖": "猪苗代湖" },
    "charStats": { "power": 85, "defense": 72, "speed": 48 },
    "relatedKeywords": ["会津若松", "猪苗代湖", "爆裂火口"],
    "dummyKanji": ["磐", "梯", "岩", "木", "鳥", "海", "会", "津"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "2,702m", "別名": "日本三名山" },
    "charStats": { "power": 92, "defense": 88, "speed": 35 },
    "relatedKeywords": ["日本三名山", "白山信仰", "高山植物"],
    "dummyKanji": ["白", "富士", "立", "山", "御", "嶽"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "2,568m", "山容": "成層火山" },
    "charStats": { "power": 95, "defense": 65, "speed": 42 },
    "relatedKeywords": ["天明の大噴火", "鬼押出し園", "軽井沢"],
    "dummyKanji": ["浅", "八", "ヶ", "岳", "御", "嶽", "三", "原"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "赤岳 (2,899m)", "延長": "約30km" },
    "charStats": { "power": 82, "defense": 85, "speed": 38 },
    "relatedKeywords": ["赤岳", "苔", "清里"],
    "dummyKanji": ["八", "浅", "間", "蓼", "科", "霧", "ヶ", "峰"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "3,067m", "特徴": "山岳信仰" },
    "charStats": { "power": 88, "defense": 82, "speed": 30 },
    "relatedKeywords": ["御嶽教", "木曽", "2014年噴火"],
    "dummyKanji": ["御", "岳", "白", "聖", "駒", "ヶ", "岳"],
    "hiddenFacts": [
    ...
    "stats": { "地形": "断崖絶壁・山岳", "指定": "世界自然遺産" },
    "charStats": { "power": 85, "defense": 90, "speed": 40 },
    "relatedKeywords": ["世界遺産", "ヒグマ", "流氷"],
    "dummyKanji": ["根", "室", "宗", "谷", "積", "丹", "渡", "島"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "北海道東端", "名所": "納沙布岬" },
    "charStats": { "power": 45, "defense": 68, "speed": 52 },
    "relatedKeywords": ["納沙布岬", "カニ", "北方領土"],
    "dummyKanji": ["知", "床", "野", "付", "宗", "谷", "襟", "裳"],
    "hiddenFacts": [
    ...
    "stats": { "名所": "龍飛崎", "地形": "青函トンネルが貫く" },
    "charStats": { "power": 62, "defense": 78, "speed": 45 },
    "relatedKeywords": ["龍飛崎", "階段国道", "太宰治"],
    "dummyKanji": ["下", "北", "男", "鹿", "牡", "鹿", "房", "総"],
    "hiddenFacts": [
    ...
    "stats": { "名所": "恐山・大間崎", "形状": "斧（まさかり）形" },
    "charStats": { "power": 55, "defense": 82, "speed": 42 },
    "relatedKeywords": ["恐山", "大間のマグロ", "仏ヶ浦"],
    "dummyKanji": ["津", "軽", "男", "鹿", "牡", "鹿", "能", "登"],
    "hiddenFacts": [
    ...
    "stats": { "文化": "ナマハゲ", "地形": "かつての島が陸続きに" },
    "charStats": { "power": 65, "defense": 72, "speed": 48 },
    "relatedKeywords": ["ナマハゲ", "入道崎", "八郎潟"],
    "dummyKanji": ["牡", "鹿", "津", "軽", "下", "北", "能", "登"],
    "hiddenFacts": [
    ...
    "stats": { "近隣": "金華山 (島)", "産業": "捕鯨・養殖" },
    "charStats": { "power": 45, "defense": 58, "speed": 62 },
    "relatedKeywords": ["石巻", "金華山", "コバルトライン"],
    "dummyKanji": ["男", "鹿", "三", "浦", "房", "総", "渥", "美"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "日本一早い日の出", "場所": "千葉県銚子市" },
    "charStats": { "power": 32, "defense": 45, "speed": 88 },
    "relatedKeywords": ["銚子", "白い灯台", "荒磯"],
    "dummyKanji": ["房", "総", "犬", "吠", "岬", "御", "前", "崎"],
    "hiddenFacts": [
    ...
    "stats": { "規模": "関東最大の半島", "気候": "温暖 (黒潮)" },
    "charStats": { "power": 58, "defense": 82, "speed": 35 },
    "relatedKeywords": ["九十九里浜", "菜の花", "海ほたる"],
    "dummyKanji": ["三", "浦", "伊", "豆", "紀", "伊", "知", "多"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "横須賀・三崎", "地形": "相模湾と東京湾の間" },
    "charStats": { "power": 48, "defense": 65, "speed": 55 },
    "relatedKeywords": ["軍港", "三浦大根", "城ヶ島"],
    "dummyKanji": ["房", "総", "伊", "豆", "能", "登", "知", "多"],
    "hiddenFacts": [
    ...
    "stats": { "由来": "フィリピン海プレートで移動", "特徴": "日本有数の温泉数" },
    "charStats": { "power": 62, "defense": 78, "speed": 38 },
    "relatedKeywords": ["世界ジオパーク", "温泉", "河津桜"],
    "dummyKanji": ["能", "登", "渥", "美", "知", "多", "志", "摩"],
    "hiddenFacts": [
    ...
    "stats": { "形状": "右手の拳のような形", "名所": "白米千枚田" },
    "charStats": { "power": 55, "defense": 85, "speed": 32 },
    "relatedKeywords": ["輪島塗", "千枚田", "和倉温泉"],
    "dummyKanji": ["伊", "豆", "丹", "後", "男", "鹿", "下", "北"],
    "hiddenFacts": [
    ...
    "stats": { "場所": "愛知県南部", "産業": "電照菊" },
    "charStats": { "power": 38, "defense": 62, "speed": 72 },
    "relatedKeywords": ["電照菊", "伊良湖岬", "三河湾"],
    "dummyKanji": ["知", "多", "房", "総", "三", "浦", "伊", "豆"],
    "hiddenFacts": [
    ...
    "stats": { "場所": "愛知県西部", "拠点": "中部国際空港 (セントレア)" },
    "charStats": { "power": 45, "defense": 55, "speed": 82 },
    "relatedKeywords": ["セントレア", "常滑焼", "海老せんべい"],
    "dummyKanji": ["渥", "美", "志", "摩", "紀", "伊", "三", "浦"],
    "hiddenFacts": [
    ...
    "stats": { "景勝地": "天橋立", "特産": "丹後ちりめん" },
    "charStats": { "power": 42, "defense": 78, "speed": 40 },
    "relatedKeywords": ["天橋立", "日本三景", "浦島太郎"],
    "dummyKanji": ["能", "登", "男", "鹿", "越", "前", "若", "狭"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "高知県土佐清水市", "特徴": "四国最南端" },
    "charStats": { "power": 45, "defense": 62, "speed": 38 },
    "relatedKeywords": ["最南端", "金剛福寺", "亜熱帯植物"],
    "dummyKanji": ["室", "戸", "佐", "田", "潮", "岬", "御", "前"],
    "hiddenFacts": [
    ...
    "stats": { "名所": "開聞岳・指宿温泉", "地形": "東は鹿児島湾・西は東シナ海" },
    "charStats": { "power": 62, "defense": 58, "speed": 65 },
    "relatedKeywords": ["指宿温泉", "開聞岳", "知覧"],
    "dummyKanji": ["大", "隅", "島", "原", "国", "東", "北", "松", "浦"],
    "hiddenFacts": [
    ...
    "stats": { "名所": "佐多岬・桜島", "地形": "シラス台地が広がる" },
    "charStats": { "power": 68, "defense": 78, "speed": 32 },
    "relatedKeywords": ["佐多岬", "シラス台地", "ロケット発射場"],
    "dummyKanji": ["薩", "摩", "島", "原", "国", "東", "北", "松", "浦"],
    "hiddenFacts": [
    ...
    "stats": { "形状": "ひょうたん形", "名産": "ホタテ" },
    "charStats": { "power": 35, "defense": 65, "speed": 40 },
    "relatedKeywords": ["ホタテ", "青森市", "まさかり半島"],
    "dummyKanji": ["内", "浦", "仙", "台", "新", "庄"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "仙台塩釜港", "産業": "漁業・物流" },
    "charStats": { "power": 45, "defense": 58, "speed": 55 },
    "relatedKeywords": ["松島", "塩釜", "石巻"],
    "dummyKanji": ["陸", "奥", "東京", "相", "模", "駿", "河"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "約1,380km²", "拠点": "東京港・横浜港・千葉港" },
    "charStats": { "power": 65, "defense": 82, "speed": 75 },
    "relatedKeywords": ["京浜工業地帯", "レインボーブリッジ", "埋立地"],
    "dummyKanji": ["相", "模", "駿", "河", "三", "河", "伊", "勢"],
    "hiddenFacts": [
    ...
    "stats": { "最大水深": "約1,600m", "名産": "シラス・干物" },
    "charStats": { "power": 52, "defense": 65, "speed": 62 },
    "relatedKeywords": ["湘南", "鎌倉", "江の島", "相模トラフ"],
    "dummyKanji": ["東", "京", "駿", "河", "三", "河", "富", "山"],
    "hiddenFacts": [
    ...
    "stats": { "最大水深": "2,500m (日本一)", "名産": "サクラエビ" },
    "charStats": { "power": 78, "defense": 85, "speed": 42 },
    "relatedKeywords": ["サクラエビ", "富士山", "深海"],
    "dummyKanji": ["相", "模", "東", "京", "三", "河", "伊", "勢"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "非常に浅い (平均9m)", "名産": "アサリ・海苔" },
    "charStats": { "power": 38, "defense": 68, "speed": 52 },
    "relatedKeywords": ["アサリ", "篠島", "日間賀島"],
    "dummyKanji": ["駿", "河", "伊", "勢", "東", "京", "富", "山"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "大阪港・神戸港", "接続": "明石海峡・紀友水道" },
    "charStats": { "power": 62, "defense": 78, "speed": 68 },
    "relatedKeywords": ["関西国際空港", "阪神工業地帯", "淡路島"],
    "dummyKanji": ["広", "島", "伊", "勢", "東京", "三", "河"],
    "hiddenFacts": [
    ...
    "stats": { "名産": "マガキ (生産量日本一)", "拠点": "広島港・呉港" },
    "charStats": { "power": 45, "defense": 62, "speed": 75 },
    "relatedKeywords": ["カキ", "宮島", "呉"],
    "dummyKanji": ["大", "阪", "瀬", "戸", "有", "明", "大", "村"],
    "hiddenFacts": [
    ...
    "stats": { "最大水深": "約1,200m", "名産": "ホタルイカ・寒ブリ" },
    "charStats": { "power": 58, "defense": 72, "speed": 45 },
    "relatedKeywords": ["ホタルイカ", "蜃気楼", "あいの風"],
    "dummyKanji": ["駿", "河", "相", "模", "若", "狭", "三", "河"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "出口が非常に狭い", "場所": "長崎県の中央部" },
    "charStats": { "power": 32, "defense": 78, "speed": 42 },
    "relatedKeywords": ["長崎空港", "ハウステンボス", "スナメリ"],
    "dummyKanji": ["有", "明", "鹿児", "島", "大", "阪", "広", "島"],
    "hiddenFacts": [
    ...
    "stats": { "別名": "錦江湾", "主峰": "桜島" },
    "charStats": { "power": 55, "defense": 68, "speed": 55 },
    "relatedKeywords": ["桜島", "錦江湾", "ブリ養殖"],
    "dummyKanji": ["有", "明", "大", "村", "広", "島", "大", "阪"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "約152km² (全国3位)", "種類": "汽水湖" },
    "charStats": { "power": 38, "defense": 72, "speed": 45 },
    "relatedKeywords": ["汽水湖", "ホタテ", "夕日"],
    "dummyKanji": ["支", "笏", "洞", "爺", "阿", "寒", "屈", "斜"],
    "hiddenFacts": [
    ...
    "stats": { "水深": "最大363m (全国2位)", "特徴": "日本最北の不凍湖" },
    "charStats": { "power": 42, "defense": 88, "speed": 35 },
    "relatedKeywords": ["カルデラ", "透明度", "チップ (ヒメマス)"],
    "dummyKanji": ["洞", "爺", "サ", "ロ", "マ", "摩", "周", "屈"],
    "hiddenFacts": [
    ...
    "stats": { "名産": "マリモ (特別天然記念物)", "場所": "釧路地方" },
    "charStats": { "power": 35, "defense": 68, "speed": 42 },
    "relatedKeywords": ["マリモ", "阿寒コタン", "アイヌ文化"],
    "dummyKanji": ["屈", "斜", "摩", "周", "知", "床", "洞", "爺"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "約1,269m (日本一)", "流出": "華厳の滝" },
    "charStats": { "power": 40, "defense": 65, "speed": 58 },
    "relatedKeywords": ["日光", "華厳の滝", "男体山"],
    "dummyKanji": ["霞", "ヶ", "浦", "印", "旛", "沼", "芦", "ノ", "湖"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "約86km² (全国5位)", "種類": "汽水湖" },
    "charStats": { "power": 32, "defense": 62, "speed": 65 },
    "relatedKeywords": ["宍道湖", "境港", "大根島"],
    "dummyKanji": ["宍", "道", "琵", "琶", "中", "海", "猪", "苗"],
    "hiddenFacts": [
    ...
    "charImage": "assets/avatars/avatar_island_wave_rider_1773565227684.png",
    "region": "hokkaido",
    "rarity": "SSR",
    "flavorText": "北方領土最大の島、火山と手つかずの自然が眠る場所",
    "stats": { "面積": "約3,139km² (日本最大 ※返還時)", "地形": "火山島" },
    "charStats": { "power": 82, "defense": 85, "speed": 35 },
    "relatedKeywords": ["北方領土", "火口湖", "散布山"],
    "dummyKanji": ["国", "後", "色", "丹", "歯", "舞", "利", "尻"],
    "hiddenFacts": [
    ...
    "stats": { "名所": "爺爺岳", "対岸": "知床半島・根室半島" },
    "charStats": { "power": 72, "defense": 78, "speed": 38 },
    "relatedKeywords": ["北方領土", "羅臼山", "爺爺岳"],
    "dummyKanji": ["択", "捉", "色", "丹", "歯", "舞", "礼", "文"],
    "hiddenFacts": [
    ...
    "stats": { "主峰": "利尻山 (利尻富士)", "名産": "利尻昆布・ウニ" },
    "charStats": { "power": 65, "defense": 82, "speed": 40 },
    "relatedKeywords": ["利尻富士", "高級昆布", "稚内"],
    "dummyKanji": ["礼", "文", "奥", "尻", "焼", "尻", "天", "売"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "約855km²", "名所": "佐渡金山・朱鷺" },
    "charStats": { "power": 75, "defense": 82, "speed": 48 },
    "relatedKeywords": ["佐渡金山", "朱鷺 (トキ)", "たらい舟"],
    "dummyKanji": ["隠", "岐", "対", "馬", "壱", "岐", "五", "島"],
    "hiddenFacts": [
    ...
    "stats": { "名産": "オリーブ・醤油", "面積": "約153km²" },
    "charStats": { "power": 38, "defense": 72, "speed": 55 },
    "relatedKeywords": ["オリーブ", "寒霞渓", "エンジェルロード"],
    "dummyKanji": ["淡", "路", "直", "島", "豊", "島", "犬", "島"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "九州と朝鮮半島の間", "固有種": "ツシマヤマネコ" },
    "charStats": { "power": 62, "defense": 85, "speed": 45 },
    "relatedKeywords": ["ツシマヤマネコ", "金田城", "朝鮮通信使"],
    "dummyKanji": ["壱", "岐", "五", "島", "隠", "岐", "佐", "渡"],
    "hiddenFacts": [
    ...
    "stats": { "指定": "世界自然遺産", "主峰": "宮之浦岳" },
    "charStats": { "power": 72, "defense": 95, "speed": 32 },
    "relatedKeywords": ["縄文杉", "世界遺産", "もののけ姫"],
    "dummyKanji": ["種", "子", "奄", "美", "徳", "之", "島", "沖", "永"],
    "hiddenFacts": [
    ...
    "stats": { "名所": "川平湾", "主峰": "於茂登岳" },
    "charStats": { "power": 48, "defense": 65, "speed": 82 },
    "relatedKeywords": ["川平湾", "石垣牛", "シュノーケリング"],
    "dummyKanji": ["宮", "古", "西", "表", "与", "那", "国", "慶", "良"],
    "hiddenFacts": [
    ...
    "type": "national_park",
    "charName": "ダイセツ-ピーク",
    "charImage": "assets/avatars/avatar_national_park_mystic_1773565241412.png",
    "region": "hokkaido",
    "rarity": "SSR",
    "flavorText": "『北海道の屋根』。日本最大の面積を誇る山岳公園",
    "stats": { "面積": "約2,267km² (日本最大)", "山": "旭岳" },
    "charStats": { "power": 88, "defense": 82, "speed": 35 },
    "relatedKeywords": ["日本最大", "カムイミンタラ", "十勝岳"],
    "dummyKanji": ["阿", "寒", "知", "床", "利", "尻", "支", "笏"],
    "hiddenFacts": [
    ...
    "type": "national_park",
    "charName": "ニッコウ-レジェンド",
    "charImage": "assets/avatars/avatar_emerald_forest_druid_1773565157583.png",
    "region": "kanto",
    "rarity": "SSR",
    "flavorText": "歴史と自然の融合、世界遺産の社寺と奥日光の絶景",
    "stats": { "指定": "世界遺産 (社寺)", "名所": "中禅寺湖・戦場ヶ原" },
    "charStats": { "power": 72, "defense": 85, "speed": 55 },
    "relatedKeywords": ["東照宮", "華厳の滝", "いろは坂"],
    "dummyKanji": ["秩", "父", "尾", "瀬", "富", "士", "箱", "根"],
    "hiddenFacts": [
    ...
    "stats": { "利用者数": "日本一", "エリア": "富士・箱根・伊豆" },
    "charStats": { "power": 95, "defense": 78, "speed": 62 },
    "relatedKeywords": ["富士山", "芦ノ湖", "城ヶ崎海岸"],
    "dummyKanji": ["秩", "父", "南", "アルプス", "中", "部", "山", "岳"],
    "hiddenFacts": [
    ...
    "stats": { "指定": "日本初 (1934年)", "特徴": "大小3,000の島々" },
    "charStats": { "power": 62, "defense": 88, "speed": 75 },
    "relatedKeywords": ["多島海", "しまなみ海道", "厳島"],
    "dummyKanji": ["大", "山", "隠", "岐", "足", "摺", "雲", "仙"],
    "hiddenFacts": [
    ...
    "stats": { "山": "阿蘇五岳・九重連山", "名所": "草千里ヶ浜" },
    "charStats": { "power": 92, "defense": 78, "speed": 45 },
    "relatedKeywords": ["カルデラ", "草千里", "ミルクロード"],
    "dummyKanji": ["雲", "仙", "西", "海", "霧", "島", "屋", "久"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "伊勢神宮", "地形": "リアス海岸 (英虞湾)" },
    "charStats": { "power": 45, "defense": 92, "speed": 55 },
    "relatedKeywords": ["伊勢神宮", "真珠養殖", "海女"],
    "dummyKanji": ["吉", "野", "熊", "野", "三", "河", "湾", "志", "摩"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "約250km²", "拠点": "斜古丹" },
    "charStats": { "power": 38, "defense": 72, "speed": 45 },
    "relatedKeywords": ["北方領土", "穴澗", "色丹村"],
    "dummyKanji": ["択", "捉", "国", "後", "歯", "舞", "奥", "尻"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "最上川", "特産": "サクランボ・将棋駒" },
    "charStats": { "power": 32, "defense": 65, "speed": 48 },
    "relatedKeywords": ["最上川", "サクランボ", "蔵王"],
    "dummyKanji": ["米", "沢", "会", "津", "横", "手", "秋", "田"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "松本市", "標高": "約600m" },
    "charStats": { "power": 38, "defense": 75, "speed": 42 },
    "relatedKeywords": ["松本城", "北アルプス", "わさび園"],
    "dummyKanji": ["長", "野", "上", "田", "佐", "久", "伊", "那"],
    "hiddenFacts": [
    ...
    "stats": { "地目": "茶畑", "拠点": "牧之原市" },
    "charStats": { "power": 35, "defense": 78, "speed": 52 },
    "relatedKeywords": ["静岡茶", "富士山", "大井川"],
    "dummyKanji": ["三", "方", "原", "富士", "裾", "野", "伊", "豆"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "256km (国内4位)", "水系": "天塩川水系" },
    "charStats": { "power": 48, "defense": 65, "speed": 82 },
    "relatedKeywords": ["大蛇行", "最北の大河", "イトウ"],
    "dummyKanji": ["石", "狩", "十", "勝", "釧", "路", "尻", "別"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "173km", "水系": "荒川水系" },
    "charStats": { "power": 62, "defense": 85, "speed": 55 },
    "relatedKeywords": ["長瀞", "荒川放水路", "都営新宿線"],
    "dummyKanji": ["利", "根", "多", "摩", "江戸", "隅", "田", "中"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "138km", "水系": "多摩川水系" },
    "charStats": { "power": 52, "defense": 78, "speed": 65 },
    "relatedKeywords": ["二子玉川", "奥多摩", "タマちゃん"],
    "dummyKanji": ["荒", "利", "根", "江戸", "相", "模", "鶴", "見"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "56km", "特徴": "世界有数の急勾配" },
    "charStats": { "power": 88, "defense": 42, "speed": 98 },
    "relatedKeywords": ["立山連峰", "砂防ダム", "デ・レイケ"],
    "dummyKanji": ["黒", "部", "神通", "庄", "川", "手", "取", "九", "頭"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "函館市", "火山": "駒ヶ岳" },
    "charStats": { "power": 55, "defense": 78, "speed": 42 },
    "relatedKeywords": ["函館", "五稜郭", "大沼公園"],
    "dummyKanji": ["知", "床", "根", "室", "積", "丹", "能", "登"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "松江市・出雲市", "名所": "出雲大社" },
    "charStats": { "power": 48, "defense": 95, "speed": 35 },
    "relatedKeywords": ["出雲大社", "日御碕", "美保関"],
    "dummyKanji": ["能", "登", "紀", "伊", "三", "浦", "房", "総"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "約40km", "幅": "最小約0.8km" },
    "charStats": { "power": 65, "defense": 42, "speed": 92 },
    "relatedKeywords": ["宇和海", "三崎", "メロディーライン"],
    "dummyKanji": ["足", "摺", "室", "戸", "高", "縄", "庄", "内"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "国東市", "山": "両子山" },
    "charStats": { "power": 52, "defense": 88, "speed": 38 },
    "relatedKeywords": ["六郷満山", "熊野磨崖仏", "ハスの花"],
    "dummyKanji": ["大", "隅", "薩", "摩", "島", "原", "宇", "土"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "えりも町", "風速": "年間平均風速10m以上" },
    "charStats": { "power": 85, "defense": 45, "speed": 95 },
    "relatedKeywords": ["日高山脈", "ゼニガタアザラシ", "風の館"],
    "dummyKanji": ["宗", "谷", "納", "沙", "布", "地球", "潮", "岬"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "本州最南端", "標高": "約30mの断崖" },
    "charStats": { "power": 55, "defense": 82, "speed": 62 },
    "relatedKeywords": ["最南端", "黒潮", "串本"],
    "dummyKanji": ["足", "摺", "室", "戸", "伊", "良", "湖", "佐", "多"],
    "hiddenFacts": [
    ...
    "stats": { "別名": "内浦湾", "特産": "ホタテガイ" },
    "charStats": { "power": 42, "defense": 78, "speed": 45 },
    "relatedKeywords": ["ホタテ養殖", "駒ヶ岳", "有珠山"],
    "dummyKanji": ["石", "狩", "仙", "台", "東", "京", "伊", "勢"],
    "hiddenFacts": [
    ...
    "stats": { "別名": "不知火海", "周囲": "天草諸島" },
    "charStats": { "power": 38, "defense": 85, "speed": 42 },
    "relatedKeywords": ["不知火", "天草", "真珠養殖"],
    "dummyKanji": ["有", "明", "土", "佐", "瀬", "戸", "内", "海"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "高知市", "特産": "カツオ" },
    "charStats": { "power": 65, "defense": 52, "speed": 78 },
    "relatedKeywords": ["桂浜", "カツオのたたき", "足摺岬"],
    "dummyKanji": ["大阪", "有", "明", "別", "府", "噴", "火", "仙", "台"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "79km²", "地質": "カルデラ湖" },
    "charStats": { "power": 68, "defense": 82, "speed": 45 },
    "relatedKeywords": ["クッシー", "美幌峠", "砂湯"],
    "dummyKanji": ["摩", "周", "サ", "ロ", "マ", "洞", "爺", "支", "笏"],
    "hiddenFacts": [
    ...
    "stats": { "透明度": "世界最高クラス", "指定": "特別保護地区" },
    "charStats": { "power": 45, "defense": 98, "speed": 32 },
    "relatedKeywords": ["霧の摩周湖", "摩周ブルー", "カムイシュ島"],
    "dummyKanji": ["屈", "斜", "路", "サ", "ロ", "マ", "十", "和", "田"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "11km²", "深さ": "233m" },
    "charStats": { "power": 35, "defense": 78, "speed": 42 },
    "relatedKeywords": ["イッシー", "オオウナギ", "開聞岳"],
    "dummyKanji": ["中", "海", "宍", "道", "猪", "苗", "代", "霞", "浦"],
    "hiddenFacts": [
    ...
    "stats": { "通称": "花の浮島", "山": "礼文岳" },
    "charStats": { "power": 38, "defense": 90, "speed": 45 },
    "relatedKeywords": ["レブンウスユキソウ", "最北の離島", "スカイ岬"],
    "dummyKanji": ["利", "尻", "奥", "尻", "佐", "渡", "壱", "岐"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "奥尻町", "名所": "なべつる岩" },
    "charStats": { "power": 45, "defense": 82, "speed": 55 },
    "relatedKeywords": ["奥尻ブルー", "なべつる岩", "ウニ・アワビ"],
    "dummyKanji": ["利", "尻", "礼", "文", "対", "馬", "五", "島"],
    "hiddenFacts": [
    ...
    "stats": { "湖": "阿寒湖・摩周湖・屈斜路湖", "火山": "雄阿寒岳・雌阿寒岳" },
    "charStats": { "power": 75, "defense": 92, "speed": 40 },
    "relatedKeywords": ["マリモ", "霧の摩周湖", "アイヌコタン"],
    "dummyKanji": ["知", "床", "大", "雪", "山", "支", "笏", "洞", "爺"],
    "hiddenFacts": [
    ...
    "stats": { "湖": "支笏湖・洞爺湖", "山": "羊蹄山・有珠山" },
    "charStats": { "power": 88, "defense": 75, "speed": 52 },
    "relatedKeywords": ["支笏湖ブルー", "洞爺湖温泉", "昭和新山"],
    "dummyKanji": ["阿", "寒", "摩", "周", "知", "床", "大", "雪", "山"],
    "hiddenFacts": [
    ...
    "stats": { "指定": "世界自然遺産", "拠点": "奄美大島・徳之島" },
    "charStats": { "power": 52, "defense": 95, "speed": 45 },
    "relatedKeywords": ["世界遺産", "マングローブ", "アマミノクロウサギ"],
    "dummyKanji": ["屋", "久", "島", "霧", "島", "西", "表", "石", "垣"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "志発島・多楽島", "対岸": "納沙布岬" },
    "charStats": { "power": 35, "defense": 65, "speed": 58 },
    "relatedKeywords": ["北方領土", "志発島", "多楽島", "貝殻島"],
    "dummyKanji": ["択", "捉", "国", "後", "色", "丹", "礼", "文"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "島後・島前", "指定": "世界ジオパーク" },
    "charStats": { "power": 58, "defense": 82, "speed": 32 },
    "relatedKeywords": ["摩天崖", "後鳥羽上皇", "ローソク島"],
    "dummyKanji": ["佐", "渡", "対", "馬", "壱", "岐", "五", "島"],
    "hiddenFacts": [
    ...
    "stats": { "歴史": "一支国", "名産": "麦焼酎・壱岐牛" },
    "charStats": { "power": 42, "defense": 68, "speed": 55 },
    "relatedKeywords": ["一支国", "麦焼酎", "猿岩"],
    "dummyKanji": ["対", "馬", "五", "島", "隠", "岐", "佐", "渡"],
    "hiddenFacts": [
    ...
    "stats": { "世界遺産": "長崎の教会群", "拠点": "福江島" },
    "charStats": { "power": 48, "defense": 85, "speed": 42 },
    "relatedKeywords": ["潜伏キリシタン", "大瀬崎灯台", "五島うどん"],
    "dummyKanji": ["対", "馬", "壱", "岐", "隠", "岐", "佐", "渡"],
    "hiddenFacts": [
    ...
    "stats": { "歴史": "鉄砲伝来 (1543年)", "拠点": "種子島宇宙センター" },
    "charStats": { "power": 65, "defense": 52, "speed": 88 },
    "relatedKeywords": ["火縄銃", "JAXA", "安納芋"],
    "dummyKanji": ["屋", "久", "奄", "美", "徳", "之", "島", "沖", "永"],
    "hiddenFacts": [
    ...
    "stats": { "指定": "世界自然遺産", "固有種": "アマミノクロウサギ" },
    "charStats": { "power": 55, "defense": 92, "speed": 40 },
    "relatedKeywords": ["世界遺産", "大島紬", "鶏飯"],
    "dummyKanji": ["徳", "之", "島", "沖", "永", "与", "論", "屋", "久"],
    "hiddenFacts": [
    ...
    "stats": { "拠点": "那覇市", "文化": "琉球文化 (首里城など)" },
    "charStats": { "power": 78, "defense": 82, "speed": 75 },
    "relatedKeywords": ["首里城", "美ら海水族館", "国際通り"],
    "dummyKanji": ["宮", "古", "石", "垣", "与", "那", "国", "西", "表"],
    "hiddenFacts": [
    ...
    "stats": { "地質": "隆起サンゴ礁", "名所": "与那覇前浜" },
    "charStats": { "power": 45, "defense": 68, "speed": 85 },
    "relatedKeywords": ["宮古ブルー", "伊良部大橋", "雪塩"],
    "dummyKanji": ["石", "垣", "西", "表", "与", "那", "国", "久", "米"],
    "hiddenFacts": [
    ...
    "stats": { "湖": "十和田湖", "渓流": "奥入瀬渓流" },
    "charStats": { "power": 78, "defense": 82, "speed": 48 },
    "relatedKeywords": ["十和田湖", "奥入瀬渓流", "八幡平"],
    "dummyKanji": ["三", "陸", "磐", "梯", "朝", "日", "日", "光"],
    "hiddenFacts": [
    ...
    "stats": { "山": "磐梯山・月山・朝日連峰", "湖": "猪苗代湖" },
    "charStats": { "power": 85, "defense": 78, "speed": 42 },
    "relatedKeywords": ["五色沼", "出羽三山", "猪苗代湖"],
    "dummyKanji": ["十", "和", "田", "八", "幡", "平", "日", "光"],
    "hiddenFacts": [
    ...
    "stats": { "山": "穂高岳・槍ヶ岳・立山", "名所": "上高地" },
    "charStats": { "power": 98, "defense": 85, "speed": 32 },
    "relatedKeywords": ["北アルプス", "上高地", "立山黒部アルペンルート"],
    "dummyKanji": ["南", "アルプス", "妙", "高", "戸", "隠", "八", "ヶ", "岳"],
    "hiddenFacts": [
    ...
    "stats": { "指定": "世界遺産 (霊場と参詣道)", "エリア": "吉野山・熊野三山" },
    "charStats": { "power": 65, "defense": 90, "speed": 48 },
    "relatedKeywords": ["吉野の桜", "那智の滝", "熊野古道"],
    "dummyKanji": ["伊", "勢", "志", "摩", "大", "山", "隠", "岐", "足", "摺"],
    "hiddenFacts": [
    ...
    "stats": { "山": "大山・三瓶山", "エリア": "隠岐諸島・島根半島" },
    "charStats": { "power": 82, "defense": 78, "speed": 40 },
    "relatedKeywords": ["伯耆富士", "出雲大社", "隠岐ジオパーク"],
    "dummyKanji": ["山", "陰", "海", "岸", "瀬", "戸", "内", "海"],
    "hiddenFacts": [
    ...
    "stats": { "山": "韓国岳・新燃岳・桜島", "エリア": "霧島・錦江湾" },
    "charStats": { "power": 95, "defense": 72, "speed": 55 },
    "relatedKeywords": ["天孫降臨", "桜島", "龍馬のハネムーン"],
    "dummyKanji": ["阿", "蘇", "雲", "仙", "西", "海", "屋", "久", "島"],
    "hiddenFacts": [
    ...
    "stats": { "指定": "世界自然遺産", "山": "宮之浦岳" },
    "charStats": { "power": 72, "defense": 95, "speed": 35 },
    "relatedKeywords": ["縄文杉", "宮之浦岳", "口永良部島"],
    "dummyKanji": ["霧", "島", "奄", "美", "雲", "仙", "阿", "蘇"],
    "hiddenFacts": [
    ...
    "stats": { "場所": "伊豆大島", "標高": "758m" },
    "charStats": { "power": 78, "defense": 62, "speed": 55 },
    "relatedKeywords": ["伊豆大島", "カルデラ", "砂漠"],
    "dummyKanji": ["三", "原", "富士", "箱", "根", "三", "浦"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "1,729m", "通称": "伯耆富士" },
    "charStats": { "power": 82, "defense": 88, "speed": 32 },
    "relatedKeywords": ["伯耆富士", "大山寺", "崩落"],
    "dummyKanji": ["大", "山", "石", "鎚", "剣", "山", "三", "瓶"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "1,982m", "別名": "西日本最高峰" },
    "charStats": { "power": 98, "defense": 90, "speed": 40 },
    "relatedKeywords": ["鎖場", "四国山脈", "西日本一"],
    "dummyKanji": ["石", "鎚", "剣", "山", "大", "山", "由", "布"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "高岳 (1,592m)", "特徴": "巨大カルデラ" },
    "charStats": { "power": 95, "defense": 85, "speed": 45 },
    "relatedKeywords": ["カルデラ", "中岳", "草千里ヶ浜"],
    "dummyKanji": ["阿", "蘇", "雲", "仙", "桜", "島", "九", "重"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "御岳 (1,117m)", "場所": "鹿児島湾" },
    "charStats": { "power": 92, "defense": 78, "speed": 52 },
    "relatedKeywords": ["大正大噴火", "火山灰", "錦江湾"],
    "dummyKanji": ["桜", "島", "開", "聞", "雲", "仙", "阿", "蘇"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "924m", "通称": "薩摩富士" },
    "charStats": { "power": 65, "defense": 58, "speed": 62 },
    "relatedKeywords": ["薩摩富士", "指宿", "螺旋登山"],
    "dummyKanji": ["開", "聞", "桜", "島", "雲", "仙", "阿", "蘇"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "156km", "主要都市": "帯広市" },
    "charStats": { "power": 62, "defense": 45, "speed": 78 },
    "relatedKeywords": ["十勝平野", "大規模農業", "大雪山"],
    "dummyKanji": ["十", "勝", "石", "狩", "天", "塩", "釧", "路"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "133km", "流域": "横手盆地・秋田平野" },
    "charStats": { "power": 52, "defense": 48, "speed": 65 },
    "relatedKeywords": ["横手盆地", "あきたこまち", "秋田市"],
    "dummyKanji": ["最", "上", "阿", "武", "隈", "北", "上", "名", "取"],
    "hiddenFacts": [
    ...
    "stats": { "流域面積": "7,710km² (全国8位)", "特徴": "水量が非常に豊富" },
    "charStats": { "power": 78, "defense": 55, "speed": 82 },
    "relatedKeywords": ["尾瀬", "阿賀川", "水力発電"],
    "dummyKanji": ["信", "濃", "最", "上", "荒", "川", "多", "摩"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "239km (全国6位)", "流域": "中通り・仙台平野" },
    "charStats": { "power": 65, "defense": 52, "speed": 72 },
    "relatedKeywords": ["中通り", "阿武隈高地", "福島市"],
    "dummyKanji": ["北", "上", "最", "上", "雄", "物", "米", "代"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "120km", "場所": "富山県・岐阜県" },
    "charStats": { "power": 72, "defense": 42, "speed": 85 },
    "relatedKeywords": ["富山湾", "飛騨山脈", "イタイイタイ病"],
    "dummyKanji": ["黒", "部", "常", "願", "寺", "庄", "川", "手", "取"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "128km", "特徴": "日本三大急流" },
    "charStats": { "power": 85, "defense": 35, "speed": 92 },
    "relatedKeywords": ["日本三大急流", "駿河湾", "甲府盆地"],
    "dummyKanji": ["木", "曽", "大", "井", "天", "竜", "相", "模"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "168km", "名言": "越すに越されぬ" },
    "charStats": { "power": 75, "defense": 52, "speed": 80 },
    "relatedKeywords": ["箱越し", "南アルプス", "SL"],
    "dummyKanji": ["天", "竜", "富士", "安倍", "木", "曽", "長", "良"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "213km (全国9位)", "源流": "諏訪湖" },
    "charStats": { "power": 88, "defense": 45, "speed": 85 },
    "relatedKeywords": ["諏訪湖", "伊那盆地", "暴れ天竜"],
    "dummyKanji": ["木", "曽", "大", "井", "富士", "庄", "川", "大", "和"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "229km", "通称": "日本ライン" },
    "charStats": { "power": 78, "defense": 58, "speed": 75 },
    "relatedKeywords": ["木曽三川", "日本ライン", "濃尾平野"],
    "dummyKanji": ["天", "竜", "大", "井", "長", "良", "揖", "斐"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "194km (中国地方1位)", "場所": "広島県・島根県" },
    "charStats": { "power": 62, "defense": 55, "speed": 58 },
    "relatedKeywords": ["中国次郎", "蛇行", "三江線"],
    "dummyKanji": ["太", "田", "芦", "田", "吉", "井", "旭", "高", "梁"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "107km", "場所": "宮崎県・鹿児島県" },
    "charStats": { "power": 48, "defense": 62, "speed": 55 },
    "relatedKeywords": ["宮崎平野", "都城盆地", "日向灘"],
    "dummyKanji": ["一", "ツ", "瀬", "川", "内", "五", "ヶ", "瀬"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "194km (四国1位)", "通称": "四国三郎" },
    "charStats": { "power": 85, "defense": 65, "speed": 88 },
    "relatedKeywords": ["四国三郎", "大歩危・小歩危", "徳島平野"],
    "dummyKanji": ["四", "万", "十", "仁", "淀", "物", "部", "那", "賀"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "136km", "場所": "奈良県・和歌山県" },
    "charStats": { "power": 55, "defense": 68, "speed": 62 },
    "relatedKeywords": ["大台ヶ原", "紀伊平野", "和歌山市"],
    "dummyKanji": ["紀", "の", "熊", "野", "有", "田", "日", "高"],
    "hiddenFacts": [
    ...
    "stats": { "別名": "新宮川", "指定": "世界遺産" },
    "charStats": { "power": 68, "defense": 72, "speed": 45 },
    "relatedKeywords": ["熊野三山", "新宮", "瀞峡"],
    "dummyKanji": ["紀", "の", "有", "田", "由", "良", "古", "座"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "115km", "特徴": "日本三大急流" },
    "charStats": { "power": 92, "defense": 45, "speed": 95 },
    "relatedKeywords": ["日本三大急流", "人吉盆地", "ラフティング"],
    "dummyKanji": ["筑", "後", "大", "分", "五", "ヶ", "瀬", "川", "内"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "平成新山 (1,483m)", "場所": "島原半島" },
    "charStats": { "power": 85, "defense": 65, "speed": 45 },
    "relatedKeywords": ["平成新山", "火砕流", "雲仙温泉"],
    "dummyKanji": ["雲", "仙", "阿", "蘇", "桜", "島", "九", "重"],
    "hiddenFacts": [
    ...
    "stats": { "農業": "あきたこまち", "河川": "雄物川" },
    "charStats": { "power": 45, "defense": 60, "speed": 40 },
    "relatedKeywords": ["あきたこまち", "雄物川", "八郎潟"],
    "dummyKanji": ["庄", "内", "仙", "台", "津", "軽", "越", "後"],
    "hiddenFacts": [
    ...
    "stats": { "主要都市": "仙台市", "河川": "名取川・阿武隈川" },
    "charStats": { "power": 55, "defense": 70, "speed": 60 },
    "relatedKeywords": ["杜の都", "ササニシキ", "伊達政宗"],
    "dummyKanji": ["秋", "田", "庄", "内", "越", "後", "濃", "尾"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "最上川", "農業": "つや姫" },
    "charStats": { "power": 42, "defense": 65, "speed": 45 },
    "relatedKeywords": ["最上川", "隠田", "鳥海山"],
    "dummyKanji": ["秋", "田", "越", "後", "富", "山", "越", "中"],
    "hiddenFacts": [
    ...
    "stats": { "面積": "約2,000km²", "河川": "信濃川・阿賀野川" },
    "charStats": { "power": 65, "defense": 82, "speed": 40 },
    "relatedKeywords": ["コシヒカリ", "信濃川", "亀田郷"],
    "dummyKanji": ["濃", "尾", "富", "山", "関", "東", "石", "狩"],
    "hiddenFacts": [
    ...
    "stats": { "地形": "複合扇状地", "河川": "神通川・常願寺川" },
    "charStats": { "power": 48, "defense": 72, "speed": 55 },
    "relatedKeywords": ["扇状地", "チューリップ", "配置薬"],
    "dummyKanji": ["越", "後", "濃", "尾", "石", "川", "福", "井"],
    "hiddenFacts": [
    ...
    "stats": { "主要都市": "大阪市・堺市", "河川": "淀川・大和川" },
    "charStats": { "power": 72, "defense": 85, "speed": 62 },
    "relatedKeywords": ["天下の台所", "淀川", "百舌鳥・古市古墳群"],
    "dummyKanji": ["濃", "尾", "岡", "山", "筑", "紫", "讃", "岐"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "大規模な干拓地", "農業": "マスカット・白桃" },
    "charStats": { "power": 45, "defense": 68, "speed": 52 },
    "relatedKeywords": ["干拓", "児島湾", "瀬戸大橋"],
    "dummyKanji": ["広", "島", "香", "川", "讃", "岐", "高", "知"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "ため池が非常に多い", "山": "飯野山 (讃岐富士)" },
    "charStats": { "power": 38, "defense": 75, "speed": 45 },
    "relatedKeywords": ["満濃池", "讃岐うどん", "弘法大師"],
    "dummyKanji": ["徳", "島", "高", "知", "愛", "媛", "道", "後"],
    "hiddenFacts": [
    ...
    "stats": { "気候": "温暖多雨", "農業": "促成栽培" },
    "charStats": { "power": 52, "defense": 48, "speed": 82 },
    "relatedKeywords": ["促成栽培", "坂本龍馬", "太平洋"],
    "dummyKanji": ["徳", "島", "香", "川", "愛", "媛", "西", "条"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "吉野川", "作物": "藍・レンコン" },
    "charStats": { "power": 45, "defense": 58, "speed": 55 },
    "relatedKeywords": ["吉野川", "阿波踊り", "藍染め"],
    "dummyKanji": ["香", "川", "高", "知", "愛", "媛", "松", "山"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "白川・緑川", "特徴": "地下水が豊富" },
    "charStats": { "power": 55, "defense": 78, "speed": 42 },
    "relatedKeywords": ["水の都", "加藤清正", "阿蘇山"],
    "dummyKanji": ["筑", "紫", "佐", "賀", "八", "代", "宮", "崎"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "球磨川", "特産": "イグサ" },
    "charStats": { "power": 42, "defense": 62, "speed": 48 },
    "relatedKeywords": ["イグサ", "畳", "干拓地"],
    "dummyKanji": ["熊", "本", "筑", "紫", "佐", "賀", "宮", "崎"],
    "hiddenFacts": [
    ...
    "stats": { "主要都市": "旭川市", "河川": "石狩川" },
    "charStats": { "power": 45, "defense": 58, "speed": 40 },
    "relatedKeywords": ["旭川", "層雲峡", "大雪山"],
    "dummyKanji": ["十", "勝", "富", "良", "野", "北", "見"],
    "hiddenFacts": [
    ...
    "stats": { "気候": "豪雪", "河川": "雄物川" },
    "charStats": { "power": 40, "defense": 65, "speed": 35 },
    "relatedKeywords": ["かまくら", "雄物川", "秋田米"],
    "dummyKanji": ["新", "庄", "米", "沢", "福島", "山", "形"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "最上川", "主要都市": "新庄市" },
    "charStats": { "power": 38, "defense": 62, "speed": 45 },
    "relatedKeywords": ["新庄まつり", "最上川", "豪雪"],
    "dummyKanji": ["横", "手", "米", "沢", "山", "形", "天", "童"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "最上川", "主要都市": "米沢市" },
    "charStats": { "power": 42, "defense": 68, "speed": 32 },
    "relatedKeywords": ["米沢牛", "上杉鷹山", "最上川"],
    "dummyKanji": ["山", "形", "新", "庄", "会", "津", "福", "島"],
    "hiddenFacts": [
    ...
    "stats": { "主要都市": "会津若松市", "山": "磐梯山" },
    "charStats": { "power": 52, "defense": 75, "speed": 35 },
    "relatedKeywords": ["鶴ヶ城", "白虎隊", "赤べこ"],
    "dummyKanji": ["福", "島", "郡", "山", "米", "沢", "中", "通"],
    "hiddenFacts": [
    ...
    "stats": { "湖": "琵琶湖", "地形": "湖成平野" },
    "charStats": { "power": 45, "defense": 82, "speed": 48 },
    "relatedKeywords": ["琵琶湖", "近江商人", "近江米"],
    "dummyKanji": ["奈", "良", "京", "都", "安", "土", "彦", "根"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "岩手県", "産業": "酪農" },
    "charStats": { "power": 35, "defense": 62, "speed": 40 },
    "relatedKeywords": ["北上川", "酪農", "冷涼"],
    "dummyKanji": ["山", "形", "武", "蔵", "野", "下", "総"],
    "hiddenFacts": [
    ...
    "stats": { "土壌": "関東ローム層", "農業": "落花生・梨" },
    "charStats": { "power": 42, "defense": 68, "speed": 55 },
    "relatedKeywords": ["落花生", "利根川", "成田空港"],
    "dummyKanji": ["武", "蔵", "野", "北", "上", "牧", "之", "原"],
    "hiddenFacts": [
    ...
    "stats": { "土壌": "関東ローム層", "地形": "広大な扇状地（台地）" },
    "charStats": { "power": 38, "defense": 72, "speed": 65 },
    "relatedKeywords": ["玉川上水", "雑木林", "多摩川"],
    "dummyKanji": ["下", "総", "牧", "之", "原", "多", "摩"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "日本最大級の茶園", "河川": "大井川" },
    "charStats": { "power": 45, "defense": 68, "speed": 52 },
    "relatedKeywords": ["お茶", "大井川", "徳川家臣"],
    "dummyKanji": ["牧", "之", "原", "笠", "野", "原", "根", "釧"],
    "hiddenFacts": [
    ...
    "stats": { "場所": "鹿児島県", "土壌": "シラス" },
    "charStats": { "power": 40, "defense": 58, "speed": 45 },
    "relatedKeywords": ["シラス台地", "大隅半島", "サツマイモ"],
    "dummyKanji": ["笠", "野", "原", "牧", "之", "原", "根", "釧"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "北海道", "特徴": "南北約140km" },
    "charStats": { "power": 35, "defense": 42, "speed": 45 },
    "relatedKeywords": ["天塩川", "利尻島", "日本海"],
    "dummyKanji": ["天", "塩", "北", "見", "夕", "張", "日", "高"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "北海道", "産業": "林業" },
    "charStats": { "power": 32, "defense": 48, "speed": 35 },
    "relatedKeywords": ["オホーツク海", "林業", "石北峠"],
    "dummyKanji": ["北", "見", "天", "塩", "阿", "寒", "大", "雪"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "夕張岳 (1,668m)", "歴史": "石炭産業" },
    "charStats": { "power": 52, "defense": 45, "speed": 38 },
    "relatedKeywords": ["夕張岳", "石炭", "夕張メロン"],
    "dummyKanji": ["張", "狩", "勝", "日", "高", "北", "見"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "幌尻岳 (2,052m)", "特徴": "国立公園" },
    "charStats": { "power": 88, "defense": 92, "speed": 22 },
    "relatedKeywords": ["幌尻岳", "氷河地形", "日本100名山"],
    "dummyKanji": ["高", "狩", "勝", "釧", "路", "根", "室"],
    "hiddenFacts": [
    ...
    "stats": { "登録": "世界自然遺産", "面積": "約13万ha" },
    "charStats": { "power": 45, "defense": 95, "speed": 32 },
    "relatedKeywords": ["世界遺産", "ブナ原生林", "青池"],
    "dummyKanji": ["神", "羽", "奥", "羽", "出", "北", "上"],
    "hiddenFacts": [
    ...
    "stats": { "地形": "隆起準平原", "位置": "福島県東部" },
    "charStats": { "power": 38, "defense": 72, "speed": 45 },
    "relatedKeywords": ["阿武隈川", "隆起準平原", "あぶくま洞"],
    "dummyKanji": ["阿", "武", "隈", "北", "上", "奥", "羽", "出", "羽"],
    "hiddenFacts": [
    ...
    "stats": { "種類": "カルデラ湖", "特徴": "日本最北の不凍湖" },
    "charStats": { "power": 45, "defense": 68, "speed": 52 },
    "relatedKeywords": ["カルデラ湖", "サミット", "有珠山", "中島"],
    "dummyKanji": ["洞", "爺", "支", "笏", "阿", "寒", "サ", "ロ", "マ"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "400m", "透明度": "非常に高い" },
    "charStats": { "power": 48, "defense": 72, "speed": 45 },
    "relatedKeywords": ["奥入瀬渓流", "二重カルデラ", "ヒメマス"],
    "dummyKanji": ["十", "和田", "田", "沢", "猪", "苗", "代"],
    "hiddenFacts": [
    ...
    "stats": { "最大水深": "423.4m (日本1位)", "伝説": "辰子姫伝説" },
    "charStats": { "power": 35, "defense": 82, "speed": 48 },
    "relatedKeywords": ["辰子像", "カルデラ湖", "日本一深い", "不凍湖"],
    "dummyKanji": ["田", "沢", "十", "和田", "猪", "苗", "代", "摩", "周"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "北奥千丈岳 (2,601m)", "国立公園": "秩父多摩甲斐" },
    "charStats": { "power": 72, "defense": 85, "speed": 35 },
    "relatedKeywords": ["秩父", "多摩", "奥多摩", "フォッサマグナ"],
    "dummyKanji": ["東", "西", "南", "北", "奥", "多", "摩", "秩", "父"],
    "hiddenFacts": [
    ...
    "stats": { "世界遺産": "霊場と参詣道", "気候": "極めて多雨" },
    "charStats": { "power": 65, "defense": 90, "speed": 42 },
    "relatedKeywords": ["紀", "伊", "和歌山", "熊野古道", "高野山"],
    "dummyKanji": ["紀", "伊", "鈴", "鹿", "中", "国", "四", "国", "九", "州"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "脊振山 (1,055m)", "位置": "福岡・佐賀" },
    "charStats": { "power": 45, "defense": 58, "speed": 52 },
    "relatedKeywords": ["筑紫平野", "脊振山", "九州北部"],
    "dummyKanji": ["紫", "佐", "賀", "熊", "本", "大", "分", "宮", "崎"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "御池岳 (1,247m)", "位置": "滋賀・三重" },
    "charStats": { "power": 55, "defense": 72, "speed": 58 },
    "relatedKeywords": ["鈴鹿峠", "伊勢湾", "琵琶湖"],
    "dummyKanji": ["鹿", "伊", "勢", "琵", "琶", "濃", "尾"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "京都・兵庫", "名産": "丹波栗・丹波黒豆" },
    "charStats": { "power": 42, "defense": 65, "speed": 35 },
    "relatedKeywords": ["丹波霧", "黒豆", "亀岡盆地"],
    "dummyKanji": ["丹", "波", "京", "都", "播", "磨", "摂", "津"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "1,898m", "別名": "蝦夷富士" },
    "charStats": { "power": 65, "defense": 55, "speed": 48 },
    "relatedKeywords": ["蝦夷富士", "成層火山", "ニセコ"],
    "dummyKanji": ["羊", "蹄", "富士", "大", "雪", "旭", "岳"],
    "hiddenFacts": [
    ...
    "stats": { "最高峰": "旭岳 (2,291m)", "特徴": "日本最大の国立公園" },
    "charStats": { "power": 92, "defense": 85, "speed": 15 },
    "relatedKeywords": ["旭岳", "神々の遊ぶ庭", "日本一早い紅葉"],
    "dummyKanji": ["雪", "氷", "寒", "北", "見", "日", "高"],
    "hiddenFacts": [
    ...
    "stats": { "位置": "洞爺湖サミット開催地付近", "状態": "活火山" },
    "charStats": { "power": 75, "defense": 35, "speed": 62 },
    "relatedKeywords": ["洞爺湖", "昭和新山", "噴火"],
    "dummyKanji": ["有", "珠", "大", "雪", "駒", "ケ", "岳"],
    "hiddenFacts": [
    ...
    "stats": { "標高": "1,625m", "別名": "津軽富士" },
    "charStats": { "power": 58, "defense": 48, "speed": 52 },
    "relatedKeywords": ["津軽富士", "リンゴ", "津軽平野"],
    "dummyKanji": ["岩", "木", "富士", "鳥", "海", "磐", "梯"],
    "hiddenFacts": [
    ...
    "stats": { "主要作物": "小麦・豆・砂糖大根", "農業形態": "大規模機械化" },
    "charStats": { "power": 55, "defense": 82, "speed": 35 },
    "relatedKeywords": ["フードバレー", "酪農", "大規模農業"],
    "dummyKanji": ["勝", "狩", "根", "釧", "筑", "紫", "佐", "賀"],
    "hiddenFacts": [
    ...
    "stats": { "農業": "稲作・果樹(リンゴ)", "位置": "青森県西部" },
    "charStats": { "power": 42, "defense": 65, "speed": 48 },
    "relatedKeywords": ["リンゴ", "岩木山", "岩木川"],
    "dummyKanji": ["軽", "秋", "田", "仙", "台", "庄", "内"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "木曽三川", "特徴": "輪中（わじゅう）" },
    "charStats": { "power": 48, "defense": 75, "speed": 42 },
    "relatedKeywords": ["木曽三川", "輪中", "伊勢湾", "名古屋"],
    "dummyKanji": ["濃", "尾", "関東", "越", "後", "富", "山"],
    "hiddenFacts": [
    ...
    "stats": { "河川": "筑後川", "農業": "稲作・麦の二毛作" },
    "charStats": { "power": 45, "defense": 62, "speed": 55 },
    "relatedKeywords": ["筑後川", "二毛作", "有明海", "クリーク"],
    "dummyKanji": ["紫", "佐", "賀", "熊", "本", "八", "代"],
    "hiddenFacts": [
    ...
    "stats": { "別称": "善光寺平", "収穫": "リンゴ・モモ" },
    "charStats": { "power": 38, "defense": 65, "speed": 42 },
    "relatedKeywords": ["千曲川", "善光寺", "リンゴ", "北信"],
    "dummyKanji": ["長", "野", "甲", "府", "京", "都", "奈", "良"],
    "hiddenFacts": [
    ...
    "stats": { "農業": "酪農", "気候": "夏に濃霧が発生" },
    "charStats": { "power": 38, "defense": 78, "speed": 25 },
    "relatedKeywords": ["酪農", "格子状防風林", "濃霧"],
    "dummyKanji": ["根", "釧", "十", "勝", "牧", "ノ", "原", "笠", "野"],
    "hiddenFacts": [
    ...
    "stats": { "土壌": "関東ローム層", "河川": "多摩川・荒川" },
    "charStats": { "power": 35, "defense": 82, "speed": 62 },
    "relatedKeywords": ["関東ローム層", "玉川上水", "都心の高台"],
    "dummyKanji": ["下", "総", "牧", "ノ", "原", "根", "釧"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "268km (全国3位)", "流域面積": "14,330km² (全国2位)" },
    "charStats": { "power": 62, "defense": 55, "speed": 78 },
    "relatedKeywords": ["石狩平野", "三日月湖", "蛇行"],
    "dummyKanji": ["石", "狩", "十", "勝", "利", "別", "天", "塩"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "249km (東北1位)", "流域面積": "10,150km²" },
    "charStats": { "power": 58, "defense": 62, "speed": 72 },
    "relatedKeywords": ["北上平野", "盛岡", "石巻"],
    "dummyKanji": ["北", "上", "阿", "武", "隈", "最", "上", "雄", "物"],
    "hiddenFacts": [
    ...
    "stats": { "水源": "琵琶湖 (瀬田川)", "流域": "滋賀・京都・大阪" },
    "charStats": { "power": 45, "defense": 82, "speed": 62 },
    "relatedKeywords": ["琵琶湖", "大阪湾", "水の都", "毛馬洗堰"],
    "dummyKanji": ["淀", "川", "最", "上", "利", "根", "木", "曽"],
    "hiddenFacts": [
    ...
    "stats": { "長さ": "143km", "愛称": "筑紫三郎" },
    "charStats": { "power": 62, "defense": 55, "speed": 82 },
    "relatedKeywords": ["筑紫三郎", "筑紫平野", "アツシマ"],
    "dummyKanji": ["筑", "後", "坂", "東", "四", "国", "球", "磨"],
    "hiddenFacts": [
    ...
    "stats": { "特徴": "日本最後の清流", "景観": "沈下橋" },
    "charStats": { "power": 35, "defense": 45, "speed": 95 },
    "relatedKeywords": ["清流", "沈下橋", "アユ釣り"],
    "dummyKanji": ["四", "万", "十", "吉", "野", "仁", "淀"],
    "hiddenFacts": [
    ...
    "region": "tohoku",
    "rarity": "R",
    "flavorText": "日本一深い、辰子姫伝説が残る瑠璃色の湖",
    "stats": { "水深": "423.4m (日本1位)", "伝説": "辰子像" },
    "charStats": { "power": 42, "defense": 78, "speed": 38 },
    "relatedKeywords": ["日本一深い", "辰子伝説", "秋田県"],
    "dummyKanji": ["田", "沢", "十", "和田", "洞", "爺", "猪", "苗", "代"],
    "hiddenFacts": [
      "Lv2: 日本一の深さを誇り、真冬でも湖面が凍ることがない",
      "Lv3: 瑠璃色の美しい水面には、永遠の美を願って龍になったという『辰子伝説』が残る",
      "Lv4: かつてはクニマスが生息していたが、戦中の水質変化で絶滅（後に西湖で発見）",
      "Lv5: 円形で美しい形をしており、『乙女の像』などの彫刻も有名"
    ]
  }, {
    "geoId": "island_sadogashima",
    "name": "佐渡島",
    "kana": "さどがしま",
    "type": "island",
    "charName": "サド-ゴールド",
    ...
    "region": "chubu",
    "rarity": "SR",
    "flavorText": "かつて日本最大の金山で栄えた、歴史とトキの島",
    "stats": { "位置": "新潟県沖", "面積": "約855km²" },
    "charStats": { "power": 45, "defense": 78, "speed": 42 },
    "relatedKeywords": ["佐渡金山", "トキ", "たらい舟", "世界遺産"],
    "dummyKanji": ["佐", "渡", "隠", "岐", "対", "馬", "淡", "路"],
    "hiddenFacts": [
      "Lv2: 2024年に『佐渡島の金山』として世界文化遺産に登録された",
      "Lv3: 特別天然記念物の『トキ』が日本で最後に野生で生息し、現在は人工繁殖が進む",
      "Lv4: 小木海岸などの『たらい舟』は、佐渡ならではのユニークな文化",
      "Lv5: 沖縄本島、北方領土を除くと、日本で最大の面積を持つ離島"
    ]
  }, {
    "geoId": "island_awajishima",
    "name": "淡路島",
    "kana": "あわじしま",
    "type": "island",
    "charName": "アワジ-ブリッジ",
    ...
    "region": "kinki",
    "rarity": "SR",
    "flavorText": "瀬戸内海最大の島、世界最長の吊り橋で本州と結ばれる",
    "stats": { "位置": "兵庫県", "橋": "明石海峡大橋" },
    "charStats": { "power": 42, "defense": 65, "speed": 68 },
    "relatedKeywords": ["明石海峡大橋", "タマネギ", "国生み神話"],
    "dummyKanji": ["淡", "路", "小", "豆", "島", "隠", "岐", "佐", "渡"],
    "hiddenFacts": [
      "Lv2: 瀬戸内海で最も面積が広く、兵庫県に属している",
      "Lv3: 世界最長級の吊り橋『明石海峡大橋』によって神戸市と結ばれている",
      "Lv4: 甘くて柔らかい『タマネギ』の生産が全国的に非常に有名",
      "Lv5: 日本神話において、日本列島の中で最初に誕生した島とされている"
    ]
  }, {
    "geoId": "island_yakushima",
    "name": "屋久島",
    ...
    "region": "kyushu",
    "rarity": "SSR",
    "flavorText": "樹齢数千年の屋久杉が眠る、生命力あふれる世界遺産の島",
    "stats": { "登録": "世界自然遺産", "特徴": "洋上のアルプス" },
    "charStats": { "power": 48, "defense": 92, "speed": 35 },
    "relatedKeywords": ["屋久杉", "縄文杉", "苔むす森", "世界遺産"],
    "dummyKanji": ["屋", "久", "種", "子", "奄", "美", "大", "島"],
    "hiddenFacts": [
      "Lv2: 標高1,000mを超える山々が連なり、『洋上のアルプス』とも呼ばれる",
      "Lv3: 樹齢3,000年以上とも言われる『縄文杉』が島のシンボル",
      "Lv4: 『1ヶ月に35日雨が降る』と言われるほど、極めて雨が多い気候",
      "Lv5: 1993年に日本で最初に世界自然遺産に登録された地の一つ"
    ]
  }, {
    "geoId": "park_shiretoko",
    "name": "知床国立公園",
    "kana": "しれとここくりつこうえん",
    "type": "national park",
    "charName": "シレトコ-オーシャン",
    ...
    "region": "hokkaido",
    "rarity": "SSR",
    "flavorText": "流氷が運ぶ恵み、海と陸が繋がる生命の循環",
    "stats": { "登録": "世界自然遺産", "位置": "北海道知床半島" },
    "charStats": { "power": 65, "defense": 82, "speed": 45 },
    "relatedKeywords": ["流氷", "ヒグマ", "知床五湖", "世界遺産"],
    "dummyKanji": ["知", "床", "阿", "寒", "摩", "周", "釧", "路"],
    "hiddenFacts": [
      "Lv2: 日本で最も原始的な自然が残る場所の一つとして知られる",
      "Lv3: 冬にはオホーツク海から『流氷』が押し寄せ、豊かな海産資源をもたらす",
      "Lv4: ヒグマの生息密度が世界屈指であり、野生動物との距離が近い",
      "Lv5: 2005年にその独自の生態系が評価され、世界自然遺産に登録"
    ]
  }, {
    "geoId": "park_sanrikufukko",
    "name": "三陸復興国立公園",
    "kana": "さんりくふっこうこくりつこうえん",
    "type": "national park",
    "charName": "サンリク-リアス",
    "charImage": "assets/avatars/avatar_water_1773059849617.png",
    "region": "tohoku",
    "rarity": "SR",
    "flavorText": "力強い断崖と美しいリアス海岸、復興のシンボル",
    "stats": { "特徴": "リアス海岸・海食崖", "位置": "青森・岩手・宮城" },
    "charStats": { "power": 55, "defense": 72, "speed": 48 },
    "relatedKeywords": ["浄土ヶ浜", "北山崎", "リアス海岸", "復興"],
    "dummyKanji": ["三", "陸", "十", "和田", "八", "幡", "平"],
    "hiddenFacts": [
      "Lv2: 東日本大震災の復興を願い、既存の公園を統合して誕生した",
      "Lv3: 南部は複雑に入り組んだリアス海岸、北部は高さ200m級の海食崖が続く",
      "Lv4: 青森県から宮城県まで約250kmにわたる日本一細長い国立公園",
      "Lv5: 豊かな海の幸を育む、世界有数の漁場としても名高い"
    ]
  }, {
    "geoId": "park_nikko",
    "name": "日光国立公園",
    ...
    "region": "kanto",
    "rarity": "SSR",
    "flavorText": "神仏への祈りと豊かな火山地形が融合する地",
    "stats": { "世界遺産": "日光の社寺", "名所": "中禅寺湖・華厳の滝" },
    "charStats": { "power": 48, "defense": 88, "speed": 42 },
    "relatedKeywords": ["東照宮", "華厳の滝", "いろは坂", "中禅寺湖"],
    "dummyKanji": ["日", "光", "尾", "瀬", "秩", "父", "多", "摩"],
    "hiddenFacts": [
      "Lv2: 徳川家康を祀る『日光東照宮』をはじめとする豪華絢爛な社寺が集まる",
      "Lv3: 男体山の噴火でできた『中禅寺湖』や、日本三大名瀑の『華厳の滝』が有名",
      "Lv4: 秋には紅葉の名所として知られ、いろは坂は大渋滞となるほど人気",
      "Lv5: 日本で最初に指定された国立公園の一つで、歴史と自然が深く結びついている"
    ]
  }, {
    "geoId": "park_setonaikai",
    "name": "瀬戸内海国立公園",
    "kana": "せとないかいこくりつこうえん",
    "type": "national park",
    "charName": "セトウチ-マジョリティ",
    "charImage": "assets/avatars/avatar_water_1773059849617.png",
    "region": "shikoku",
    "rarity": "SSR",
    "flavorText": "多島美と穏やかな海、日本最初の国立公園",
    "stats": { "規模": "日本最大級の面積", "特徴": "内航航路" },
    "charStats": { "power": 45, "defense": 65, "speed": 88 },
    "relatedKeywords": ["多島美", "しまなみ海道", "小豆島", "日本最初"],
    "dummyKanji": ["瀬", "戸", "内", "大", "山", "隠", "岐"],
    "hiddenFacts": [
      "Lv2: 1934年に日本で最初に指定された国立公園の一つ",
      "Lv3: 大小1,000以上の島々が織りなす『多島美（たとうび）』が世界的に評価されている",
      "Lv4: 穏やかな海は古くから物流の要所であり、現在も多くの大型船が往来する",
      "Lv5: 鳴門の渦潮や明石海峡など、急流が有名なスポットも点在する"
    ]
  }
];
